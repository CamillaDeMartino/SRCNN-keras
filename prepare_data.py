...
# DATA_PATH = "/home/camilla/Scaricati/SRCNN-keras-master/T91/"
# TEST_PATH = "/home/camilla/Scaricati/SRCNN-keras-master/Set14/original/"
DATA_PATH = "/home/camilla/Scaricati/SRCNN-keras-master/Train_RGB/"
TEST_PATH = "/home/camilla/Scaricati/SRCNN-keras-master/Test_RGB/"
...
if __name__ == "__main__":
    ...
    RGB_FOLDER = "/home/camilla/Scrivania/Tesi/RGB"
    TRAIN_RGB = DATA_PATH
    TEST_RGB = TEST_PATH
    ...
    all_images = sorted([f for f in os.listdir(RGB_FOLDER) if f.endswith(".png")])
    ...
    for img in train_imgs:
        shutil.copy(os.path.join(RGB_FOLDER, img), os.path.join(TRAIN_RGB, img))
    for img in test_imgs:
        shutil.copy(os.path.join(RGB_FOLDER, img), os.path.join(TEST_RGB, img))


    print(len(os.listdir(TRAIN_RGB)))
    print(len(os.listdir(TEST_RGB)))
