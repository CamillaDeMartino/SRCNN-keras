...
img = cv2.imread(str(ASSETS_DIR / 'input2.jpg'), cv2.IMREAD_COLOR)
img = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)

img1 = cv2.imread(str(OUTPUTS_DIR / 'pre2.png'), cv2.IMREAD_COLOR)
img1 = cv2.cvtColor(img1, cv2.COLOR_BGR2GRAY) 

img2 = cv2.imread(str(ASSETS_DIR / 'input2.jpg'), cv2.IMREAD_COLOR)
img2 = cv2.cvtColor(img2, cv2.COLOR_BGR2GRAY) 

img3 = cv2.imread(str(ASSETS_DIR / 'pre2.jpg'), cv2.IMREAD_COLOR)
...
input = cv2.imread(str(ASSETS_DIR / 'input2.jpg'),cv2.IMREAD_COLOR)
output = cv2.imread(str(ASSETS_DIR / 'pre2.jpg'), cv2.IMREAD_COLOR)
